...
public class VoiceChatSettingsScreen extends VoiceChatScreenBase {
    ...
    protected void init() {
        ...
        if (agc) {
            addButton(new AgcButton(this, guiLeft + 10, y, 80, 20, active -> micAmp.setActive(!active)));
        }
        addButton(micAmp);
        y += 21;
        ...
        addButton(new MicActivationButton(guiLeft + 10 + 20 + 1, y, xSize - 20 - 20 - 1, 20, type -> {
