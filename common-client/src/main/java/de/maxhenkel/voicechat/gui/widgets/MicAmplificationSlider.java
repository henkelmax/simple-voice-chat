...
public class MicAmplificationSlider extends DebouncedSlider {
    ...
    private static final Component GAIN_WARNING = Component.translatable("message.voicechat.microphone_gain.warning", GAIN_WARNING_THRESHOLD).withStyle(ChatFormatting.RED);
