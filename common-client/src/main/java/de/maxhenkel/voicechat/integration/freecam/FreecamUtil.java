...
public class FreecamUtil {
     ...
     */
    public static Vec3d getReferencePoint(CameraState camera) {
     ...
     */
    public static double getDistanceTo(CameraState camera, Vec3d pos) {
     ...
     */
    public static float getDistanceVolume(CameraState camera, float maxDistance, Vec3d pos) {
