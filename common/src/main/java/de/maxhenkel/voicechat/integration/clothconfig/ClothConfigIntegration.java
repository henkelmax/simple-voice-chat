...
public class ClothConfigIntegration {
    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        general.addEntry(fromConfigEntry(entryBuilder, new TranslatableComponent("cloth_config.voicechat.config.mute_on_join"), VoicechatClient.CLIENT_CONFIG.muteOnJoin));
