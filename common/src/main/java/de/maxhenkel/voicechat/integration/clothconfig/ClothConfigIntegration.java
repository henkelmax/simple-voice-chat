...
public class ClothConfigIntegration {
    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        general.addEntry(entryBuilder
                ...
                .setEnumNameProvider(e -> new TranslatableComponent(String.format("cloth_config.voicechat.config.freecam_mode.%s", e.name().toLowerCase())))
        ...
        groupIcons.addEntry(entryBuilder
                ...
                .setEnumNameProvider(e -> new TranslatableComponent(String.format("cloth_config.voicechat.config.group_player_icon_orientation.%s", e.name().toLowerCase())))
