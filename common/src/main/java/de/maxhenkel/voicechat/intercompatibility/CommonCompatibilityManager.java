...
public abstract class CommonCompatibilityManager {
     ...
     */
    public abstract void onPlayerHide(BiConsumer<ServerPlayerEntity, ServerPlayerEntity> onPlayerHide);

    /**
     * @param onPlayerShow (visibilityChangedPlayer, observingPlayer)
     */
    public abstract void onPlayerShow(BiConsumer<ServerPlayerEntity, ServerPlayerEntity> onPlayerShow);
