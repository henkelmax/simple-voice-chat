...
public class PositionalAudioUtils {
     ...
     */
    public static float getDistanceVolume(InitializationData initializationData, Vector3d pos) {
     ...
     * @return the resulting audio volume
     */
    public static float getDistanceVolume(InitializationData initializationData, Vector3d pos, float distanceMultiplier) {
     ...
     * @return the resulting audio volume
     */
    public static float getDistanceVolume(InitializationData initializationData, Vector3d listenerPos, Vector3d pos, float distanceMultiplier) {
    ...
    public static short[] convertToStereoForRecording(InitializationData initializationData, Vector3d pos, short[] monoData) {
        return convertToStereoForRecording(initializationData, pos, monoData, 1F);
    }

    public static short[] convertToStereoForRecording(InitializationData initializationData, Vector3d pos, short[] monoData, float distanceMultiplier) {
    ...
    public static short[] convertToStereoForRecording(InitializationData initializationData, Vector3d cameraPos, float yRot, Vector3d pos, short[] monoData, float distanceMultiplier) {
