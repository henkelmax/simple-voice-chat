...
public class PositionalAudioUtils {
     ...
     * @return the resulting audio volume
     */
    public static float getDistanceVolume(float maxDistance, Vec3 pos, float distanceMultiplier) {
     ...
     * @return the resulting audio volume
     */
    public static float getDistanceVolume(float maxDistance, Vec3 listenerPos, Vec3 pos, float distanceMultiplier) {
    ...
    public static short[] convertToStereoForRecording(float maxDistance, Vec3 pos, short[] monoData, float distanceMultiplier) {
    ...
    public static short[] convertToStereoForRecording(float maxDistance, Vec3 cameraPos, float yRot, Vec3 pos, short[] monoData, float distanceMultiplier) {
