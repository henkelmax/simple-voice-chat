...
public class ClothConfigWrapper {
    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        audio.addEntry(fromConfigEntry(entryBuilder, Component.translatable("cloth_config.voicechat.config.recording_destination"), VoicechatClient.CLIENT_CONFIG.recordingDestination));
        audio.addEntry(fromConfigEntry(entryBuilder, Component.translatable("cloth_config.voicechat.config.run_local_server"), VoicechatClient.CLIENT_CONFIG.runLocalServer));
        audio.addEntry(fromConfigEntry(entryBuilder, Component.translatable("cloth_config.voicechat.config.offline_player_volume_adjustment"), VoicechatClient.CLIENT_CONFIG.offlinePlayerVolumeAdjustment));
