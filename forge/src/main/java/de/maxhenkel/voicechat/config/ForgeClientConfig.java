...
public class ForgeClientConfig extends ClientConfig {
    ...
    public ForgeClientConfig(ConfigBuilder builder) {
        ...
        javaMicrophoneImplementation = builder.booleanEntry("java_microphone_implementation", true); // TODO Fix AL microphone
