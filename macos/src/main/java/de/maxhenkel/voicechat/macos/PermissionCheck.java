...
public class PermissionCheck {
    ...
    private interface AVFoundationLibrary extends Library {
        AVFoundationLibrary INSTANCE = Native.loadLibrary("AVFoundation", AVFoundationLibrary.class, Collections.singletonMap(Library.OPTION_STRING_ENCODING, StandardCharsets.UTF_8.name()));
    ...
    private interface FoundationLibrary extends Library {
        FoundationLibrary INSTANCE = Native.loadLibrary("Foundation", FoundationLibrary.class, Collections.singletonMap(Library.OPTION_STRING_ENCODING, StandardCharsets.UTF_8.name()));
