...
public interface CoreFoundation extends Library {
    ...
    class CFTypeRef extends PointerType {
         ...
         *
         * @param typeID The {@link CFTypeID} for the class to test
    ...
    class CFDictionaryRef extends CFTypeRef {
         ...
         *
         * @param key   The key for which to find a match.
         * @param value A pointer to memory which, on return, is filled with the
    ...
    class CFMutableDictionaryRef extends CFDictionaryRef {
         ...
         * @param value The value to add to or replace .
         */
    ...
    class CFStringRef extends CFTypeRef {
         ...
         * references.
         *
         * @param s A {@link java.lang.String}.
     ...
     * references.
     *
     * @param alloc  The allocator to use to allocate memory for the new string. Pass
     ...
     * @param length The number of characters in the buffer pointed to by chars. Only
     ...
     * references.
     *
     * @param alloc    The allocator to use to allocate memory for the new object. Pass
     *                 {@code null} or {@code kCFAllocatorDefault} to use the current
     *                 default allocator.
     ...
     * references.
     *
     * @param alloc     The allocator to use to allocate memory for the new array and its
     *                  storage for values. Pass {@code null} or
     *                  {@code kCFAllocatorDefault} to use the current default allocator.
     * @param values    A C array of the pointer-sized values to be in the new array. The
     ...
     *                  undefined.
     * @param numValues The number of values to copy from the {@code values} C array into
     ...
     *                  values.
     * @param callBacks A pointer to a {@code CFArrayCallBacks} structure initialized with
     ...
     *               {@code null} or {@code kCFAllocatorDefault} to use the current
     *               default allocator.
     * @param bytes  A pointer to the byte buffer that contains the raw data to be
     *               copied into the Data.
     * @param length The number of bytes in the buffer ({@code bytes}).
     ...
     * @param keyCallBacks   A pointer to a {@code CFDictionaryKeyCallBacks} structure
     ...
     * @param valueCallBacks A pointer to a {@code CFDictionaryValueCallBacks} structure
     *                       initialized with the callbacks to use to retain, release,
     ...
     * @param key     The key for which to find a match in {@code theDict}. The key hash
     ...
     *
     * @param theDict The dictionary to modify. If this parameter is a fixed-capacity
     *                dictionary and it is full before this operation, and the key does
     *                not exist in the dictionary, the behavior is undefined.
     * @param key     The key of the value to set in {@code theDict}. If a key which
     ...
     * @param value   The value to add to or replace in {@code theDict}. {@code value}
     ...
     * @param bufferToFill The C string buffer into which to copy the string. On return, the
     ...
     *
     * @param theArray a {@link CFArrayRef} object.
     ...
     *
     * @param theArray The array to examine.
     * @param idx      The index of the value to retrieve. If the index is outside the
     ...
     *
     * @param number The {@code CFNumber} object to examine.
     ...
     *
     * @param number   The {@code CFNumber} object to examine.
     * @param theType  A constant that specifies the data type to return. See
     *                 {@link CFNumberType} for a list of possible values.
     * @param valuePtr On return, contains the value of {@code number}.
     ...
     *
     * @param length   The number of Unicode characters to evaluate.
     * @param encoding The string encoding for the number of characters specified by
     *                 length.
     ...
     *
     * @param theObject The {@code CFData} object to examine.
