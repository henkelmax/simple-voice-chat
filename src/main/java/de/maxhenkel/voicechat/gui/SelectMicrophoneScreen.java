...
public class SelectMicrophoneScreen extends ListScreen<String> {
    ...
    public void updateCurrentElement() {
        ...
        int bw = 60;
        Button b = addButton(new Button(width / 2 - bw / 2, guiTop + 35, bw, 20, new TranslationTextComponent("message.select"), button -> {
    ...
    protected void renderText(MatrixStack stack, @Nullable String element, int mouseX, int mouseY, float partialTicks) {
        ...
        IFormattableTextComponent name = getCurrentElement() == null ? new TranslationTextComponent("message.no_microphone") : new StringTextComponent(getCurrentElement());
