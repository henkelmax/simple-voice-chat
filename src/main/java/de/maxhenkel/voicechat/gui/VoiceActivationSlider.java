...
public class VoiceActivationSlider extends AbstractSlider {
    ...
    protected VoiceActivationSlider(int xIn, int yIn, int widthIn, int heightIn) {
        super(xIn, yIn, widthIn, heightIn, Utils.dbToPerc(Main.CLIENT_CONFIG.voiceActivationThreshold.get().floatValue()));
        updateMessage();
    }
    ...
    protected void updateMessage() {
        ...
        setMessage(new TranslationTextComponent("message.voice_activation", db).getString());
    }
