...
public class GroupList extends WidgetBase {
    ...
    private static final ResourceLocation SPEAKER_OFF = new ResourceLocation(Main.MODID, "textures/gui/speaker_small_off.png");
    private static final ResourceLocation SPEAKER = new ResourceLocation(Main.MODID, "textures/gui/speaker_small.png");
    ...
    public void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        for (int i = getOffset(); i < entries.size() && i < getOffset() + columnCount; i++) {
            ...
            mc.font.draw(matrixStack, new StringTextComponent(state.getGameProfile().getName()), guiLeft + 3 + 16 + 1 + 16 + 3, startY + 7, 0);
        }
    }
