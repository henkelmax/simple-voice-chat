...
public class GroupList extends WidgetBase {
    ...
    private static final ResourceLocation SPEAKER_OFF = new ResourceLocation(Main.MODID, "textures/gui/speaker_off.png");
    private static final ResourceLocation SPEAKER = new ResourceLocation(Main.MODID, "textures/gui/speaker.png");
    private static final ResourceLocation CHANGE_VOLUME = new ResourceLocation(Main.MODID, "textures/gui/change_volume.png");
    private static final ResourceLocation DISCONNECT = new ResourceLocation(Main.MODID, "textures/gui/disconnected.png");
    ...
    public GroupList(VoiceChatScreenBase screen, int posX, int posY, int xSize, int ySize, Supplier<List<PlayerState>> playerStates) {
        ...
        voiceChatClient = Main.CLIENT_VOICE_EVENTS.getClient();
    ...
    public void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        for (int i = getOffset(); i < entries.size() && i < getOffset() + columnCount; i++) {
            ...
            mc.font.draw(matrixStack, new StringTextComponent(state.getGameProfile().getName()), guiLeft + 3 + 16 + 1 + 8 + 3, startY + 7, 0);
        }
    }
